...
//       const response = await axios.post('http://localhost:3000/get-partial-dishes-with-images', allItems, {
//         headers: {
//           'Content-Type': 'application/json'
//         }
//       });
...
//       const response = await axios.post('http://localhost:3000/get-dishes-with-images', allItems, {
//         headers: {
//           'Content-Type': 'application/json'
//         }
//       });
...
//           {/* Image Generation Button Section - Modified */}
// <div className="image-generation-section">
